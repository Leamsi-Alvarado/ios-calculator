...
export const CalculatorScreen = () => {
    const { number, prevNumber, buildNumber,calculateResult, formula, toggleSign, clean, deleteOperation, addOperation, subsctractOperation, multiplyOperation, divideOperation
    } = useCalculator();
    return (
        <View style={styles.calculatorContainer}>
            <View style={{ paddingHorizontal: 30, paddingBottom: 20 }}>
                ...
                {
                    (formula === prevNumber) ? <Text style={styles.subResult}></Text> : <Text style={styles.subResult}>{prevNumber}</Text>
            ...
            <View style={styles.row}>
                ...
                <CalculatorButton onPress={subsctractOperation} label='-' color={colors.orange} />
            </View>
            <View style={styles.row}>
